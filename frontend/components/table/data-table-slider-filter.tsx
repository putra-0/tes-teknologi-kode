...
export function DataTableSliderFilter<TData>({ table, column, title }: DataTableSliderFilterProps<TData>) {
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="outline" size="sm" className="border-dashed" disabled={table.getState().globalFilter}>
          {columnFilterValue ? (
            <div
              role="button"
